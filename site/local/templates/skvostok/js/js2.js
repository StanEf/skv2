...
angular.module("website.core.settings", ["ng"]), angular.module("website.core.dependency", ["website.core.settings"]), angular.module("website", ["core.library.jsonrpc", "website.core", "website.widgets", "website.plugins", "website.moto_link", "moto.validation"]).run(["jsonrpc", function (a) {
    ...
    console.log("website.core.dependency");
    return {
    ...
    console.log("website.core.dependency4444");
    var h = {}, i = angular.element("head").get(0), j = angular.element("body").get(0),
        k = {en: "en_US", de: "de_DE", ru: "ru_RU"}, l = {};
    l = {
        disqus: {
            name: "disqus",
    ...
    function d(a) {
        ...
        var b, c = a.isAttached || a.options.hidden ? a.$pseudoElement : a.$element,
            d = c.get(0).getBoundingClientRect(), e = !1, f = a.options.offset, g = parseInt(c.css("marginTop")) || 0;
    ...
    function k(a, b, d) {
        try {
            ...
            var e = a.$eval(d.motoSticky),
                f = {$scope: a, $element: b, $attrs: d, options: angular.extend({}, p, e), isAttached: !1};
            j(f), h(f), q.push(f)
        } catch (a) {
    ...
    if (a.listId = "", a.message = {}, a.emailSent = !1, a.triedToSend = !1, a.emailError = !1, a.isSubscribed = !1, h.length)for (var j = 0, k = h.length; j < k; j++)f = angular.element(h[j]), g = f.attr("name"), g && (a.message[g] = a.message[g] || "");
    a.validateEmailOnBlur = function () {
